...
2. **Add a new competition**

3. **competition entries, export to CSV**
...
= 1.6 =
Fixed PHP warning preventing CSV download

= 1.7 =
Fixed redeclare function issue

= 1.8 =
Added mulitple Checkbox Support

= 1.9 =
Fixed form input spinner issue for first entry

= 2.0 =
Fixed download to CSV issue with on competitions with high number of entries.